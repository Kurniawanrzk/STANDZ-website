...
const SellerHomepagewithMenuPanelPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    <>
      <div className="bg-lime-600 flex flex-col font-kd items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
          <Sidebar1 className="!sticky !w-[264px] bg-gray-300 flex h-screen md:hidden justify-start overflow-auto md:px-5 rounded-[35px] top-[0]" />
          <div className="flex flex-1 flex-col font-inriasans justify-start md:px-5 w-full">
            <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between md:ml-[0] ml-[15px] w-[96%] md:w-full">
            ...
            <div className="flex flex-col font-mavenpro items-start justify-start mt-[55px] overflow-auto w-full">
              <Text
              ...
              <div className="flex md:flex-col flex-row font-inriasans gap-[41px] items-center justify-end md:ml-[0] ml-[13px] mt-4 w-full">
                <List
              ...
              <Text
                className="mt-[55px] md:text-4xl sm:text-[34px] text-[38px] text-black-900"
                size="txtMavenProBold38"
              >
                All Lands
              </Text>
              <div className="font-lucidasans md:ml-[0] ml-[13px] mt-2.5 overflow-x-auto w-[99%]">
                <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                  ...
                  <div className="md:h-[392px] sm:h-[414px] h-[438px] relative w-[23%] md:w-full">
                  ...
                  <div className="md:h-[424px] h-[439px] mb-0.5 relative w-[23%] md:w-full">
            ...
            <div className="flex flex-row font-jua items-center justify-start md:ml-[0] ml-[324px] mt-[35px] w-[22%] md:w-full">
...
export default SellerHomepagewithMenuPanelPage;
