...
const ReccomendationsOnePage = () => {
  return (
    <>
      <div className="bg-lime-600 flex flex-col items-center justify-end mx-auto p-5 w-full">
        <div className="flex flex-col items-start justify-start max-w-[1333px] mt-[27px] mx-auto md:px-5 w-full">
          <div className="flex md:flex-col flex-row font-inriasans md:gap-10 items-start justify-between ml-2 md:ml-[0] w-full">
            <div className="flex md:flex-1 sm:flex-col flex-row sm:gap-10 items-center justify-between w-[45%] md:w-full">
              <Img
              ...
              />
              <div
                className="bg-cover bg-no-repeat flex flex-col h-[43px] items-start justify-start p-[7px] rounded-[21px]"
            ...
            <div className="flex md:flex-1 flex-row font-mitr items-center justify-start md:mt-0 mt-[5px] w-[23%] md:w-full">
              <Img
          ...
          <Text
            className="md:ml-[0] ml-[7px] mt-[57px] md:text-4xl sm:text-[34px] text-[38px] text-black-900"
            size="txtMavenProBold38"
          >
            Nearby
          </Text>
          <div className="flex md:flex-col flex-row font-lilitaone md:gap-10 items-center justify-between ml-1 md:ml-[0] mt-[5px] w-[97%] md:w-full">
          ...
          <div className="flex md:flex-col flex-row font-lusitana md:gap-5 items-center justify-start md:ml-[0] ml-[7px] mt-[13px] w-[72%] md:w-full">
...
export default ReccomendationsOnePage;
