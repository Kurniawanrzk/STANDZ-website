...
const WalletPage = () => {
  return (
    <>
      <div className="bg-deep_orange-A100 flex flex-col items-center justify-end mx-auto pt-9 w-full">
        <div className="flex flex-col items-center justify-end w-full">
          <div className="flex sm:flex-col flex-row font-mitr md:gap-10 items-start justify-between max-w-[1318px] mx-auto md:px-5 w-full">
            ...
            <div className="flex sm:flex-1 flex-row items-center justify-between sm:mt-0 mt-[18px] w-[22%] sm:w-full">
              <Img
            ...
            <div className="flex flex-col items-center justify-start max-w-[1250px] mb-[454px] mx-auto md:px-5 w-full">
              <div className="flex flex-col gap-[37px] justify-start w-full">
                ...
                <div className="flex flex-col font-lustria gap-[19px] items-start justify-start w-full">
                  ...
                  <div className="bg-red-300_01 border border-black-900 border-solid flex flex-col items-center justify-end p-[11px] rounded-[25px] w-full">
