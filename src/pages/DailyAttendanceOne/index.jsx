...
const DailyAttendanceOnePage = () => {
  return (
    <>
      <div className="bg-lime-600 flex flex-col font-mitr items-center justify-start mx-auto p-[39px] sm:px-5 w-full">
        <div className="flex flex-col md:gap-10 gap-[67px] items-center justify-start max-w-[1319px] mb-[522px] mx-auto md:px-5 w-full">
          <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
            ...
            <div className="flex md:flex-1 flex-row items-center justify-start w-[21%] md:w-full">
              <Img
...
export default DailyAttendanceOnePage;
