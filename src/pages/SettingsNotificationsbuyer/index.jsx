...
const SettingsNotificationsbuyerPage = () => {
  return (
    <>
      <div className="bg-deep_orange-A100 font-mitr h-[1024px] mx-auto p-[39px] sm:px-5 relative w-full">
        <div className="absolute flex flex-row items-center justify-center md:px-5 right-[4%] top-[6%] w-1/5">
          <Img
          ...
          />
          <Img
            className="h-[33px] md:h-auto ml-[26px] object-cover w-[34px]"
            src="images/img_speechbubble7647467.png"
            alt="speechbubble764"
          />
          <div className="flex flex-row gap-[11px] items-center justify-start ml-10 w-[53%]">
            <Img
        ...
        <div className="absolute flex flex-col md:gap-10 gap-[95px] justify-start left-[3%] md:px-5 top-[4%] w-[88%]">
          <div className="flex flex-row gap-[38px] items-start justify-start w-[24%] md:w-full">
            <Img
          ...
          <div className="flex flex-col items-center justify-start md:ml-[0] ml-[18px] w-[99%] md:w-full">
              ...
              <div className="bg-light_green-200 flex flex-col items-start justify-start p-[18px] w-full">
                <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mb-[31px] md:ml-[0] ml-[7px] w-[73%] md:w-full">
                  <div className="flex flex-col gap-[7px] justify-start">
                    ...
                    >
                      You will be notified of any material changes, but you can
                      decide what information you would like to receive.
                    </Text>
                  </div>
                  <List
...
export default SettingsNotificationsbuyerPage;
