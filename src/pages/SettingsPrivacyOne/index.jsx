          ...
          <div className="flex flex-col md:gap-10 gap-[95px] items-center justify-start w-full">
            ...
            <div className="flex flex-col items-center justify-start w-[95%] md:w-full">
              <div className="flex flex-col gap-[34px] items-center justify-start w-full">
                ...
                <div className="bg-light_green-200 flex flex-col items-center justify-start p-[22px] sm:px-5 w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mb-[19px] w-[98%] md:w-full">
                    <div className="flex flex-col justify-start mb-2 w-[48%] md:w-full">
                      <Text
                        className="text-5xl sm:text-[38px] md:text-[44px] text-black-900"
                        size="txtMitrRegular48"
                      >
                    ...
                    <div className="flex flex-col items-start justify-start md:mt-0 mt-[81px] w-2/5 md:w-full">
                      <Text
                      ...
                      <div className="flex sm:flex-col flex-row gap-3 items-start justify-start mt-1 w-full">
                        <Img
                          className="h-10 w-10"
                          src="images/img_checkmark.svg"
                          alt="checkmark_One"
                      ...
                      <Text
                        className="md:ml-[0] ml-[5px] mt-[41px] text-3xl sm:text-[26px] md:text-[28px] text-black-900"
                        size="txtMitrRegular30Black900"
                      >
                        Clear your data and accounts
                      </Text>
                      <div className="bg-light_green-200_cc flex flex-col items-center justify-end ml-5 md:ml-[0] mt-[5px] w-1/2 md:w-full">
                        <div className="flex flex-row gap-2 items-center justify-center mt-[7px] w-[56%] md:w-full">
                          <Img
                            className="h-10 w-10"
...
export default SettingsPrivacyOnePage;
