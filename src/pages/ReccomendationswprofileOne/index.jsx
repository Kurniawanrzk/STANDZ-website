...
const ReccomendationswprofileOnePage = () => {
  return (
    <>
      <div className="bg-deep_orange-A100 flex flex-col font-lilitaone gap-5 items-start justify-center mx-auto p-[17px] w-full">
        <div className="flex flex-col items-center max-w-[1364px] mt-[27px] mx-auto pl-1 md:px-5 w-full">
          <div className="md:h-[1511px] sm:h-[368px] h-[536px] relative w-full">
            <div className="flex flex-col md:gap-10 gap-[70px] h-full items-start justify-start ml-[3px] mt-1 w-[82%]">
              <div className="flex md:flex-col flex-row font-inriasans md:gap-5 items-center justify-start w-full">
                <Img
                  className="md:flex-1 h-[38px] sm:h-auto object-cover rounded-[9px] w-[5%] md:w-full"
                  src="images/img_menu18288591.png"
                  alt="menu18288591"
                />
                <div
                  className="bg-cover bg-no-repeat flex md:flex-1 flex-col h-[43px] items-start justify-start md:ml-[0] ml-[62px] p-[7px] rounded-[21px] w-[44%] md:w-full"
            ...
            <div className="absolute md:h-[1511px] sm:h-[368px] h-[536px] inset-[0] justify-center m-auto w-full">
              <div className="absolute bottom-[0] flex md:flex-col flex-row md:gap-10 items-center justify-between left-[0] w-[95%]">
                <div className="bg-blue_gray-100 flex flex-col gap-[9px] items-center justify-start md:mt-0 mt-0.5 pb-[15px] rounded-[35px] w-[23%] md:w-full">
                  <Img
              ...
              <div className="absolute flex flex-col font-mitr items-center justify-start right-[0] top-[0] w-[15%]">
                <div className="flex flex-row items-start justify-evenly w-full">
                  <Img
                    ...
                    alt="redvelvetjoyesp"
                  />
                  <div className="flex flex-col items-end justify-start mt-1 w-3/4">
                    <div className="flex flex-row items-center justify-end w-[93%] md:w-full">
                      <Text
                      ...
                      <Img
                        className="h-[41px] md:h-auto ml-1 object-cover w-[37%]"
                        src="images/img_chevronup.png"
                        alt="chevronup"
                      />
                    </div>
                    <div className="bg-blue_gray-100 flex flex-col font-mada items-start justify-start p-[7px] rounded-[15px] w-full">
        ...
        <div className="flex flex-col font-mavenpro gap-[13px] justify-start mb-[3px] md:ml-[0] ml-[42px] md:px-5 w-[68%] md:w-full">
          <Text
            className="md:text-4xl sm:text-[34px] text-[38px] text-black-900"
            size="txtMavenProBold38"
          >
          ...
          <div className="flex md:flex-col flex-row font-lusitana md:gap-10 items-center justify-between md:ml-[0] ml-[7px] w-full">
            <div className="bg-blue_gray-100 flex md:flex-1 flex-col gap-[7px] items-center justify-start pb-3.5 rounded-[35px] w-[31%] md:w-full">
              <Img
            ...
            <div className="md:h-[292px] h-[344px] relative w-[31%] md:w-full">
              <div className="absolute bg-blue_gray-100 flex flex-col h-full inset-[0] items-start justify-center m-auto p-3.5 rounded-[35px] w-full">
...
export default ReccomendationswprofileOnePage;
