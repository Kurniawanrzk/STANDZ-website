...
const ReccomendationswmenuPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
  ...
  return (
    <>
      <div className="bg-deep_orange-A100 flex flex-col font-kd items-center justify-end mx-auto w-full">
        <div className="overflow-x-auto w-full">
          <div className="flex md:flex-col flex-row md:gap-[45px] items-center justify-between overflow-auto w-full">
            ...
            <div className="flex md:flex-1 flex-col font-inriasans md:gap-10 gap-[66px] justify-start md:px-5 w-[90%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start md:ml-[0] ml-[106px] w-[78%] md:w-full">
                <div
                  className="bg-cover bg-no-repeat flex flex-col h-[43px] items-start justify-start p-[7px] rounded-[21px] w-[49%] md:w-full"
                ...
                <Img
                  className="h-9 md:h-auto md:ml-[0] ml-[184px] object-cover w-[35px] sm:w-full"
              ...
              <div className="flex flex-col font-mavenpro items-start justify-start w-full">
                <Text
                  className="md:ml-[0] ml-[7px] md:text-4xl sm:text-[34px] text-[38px] text-black-900"
                  size="txtMavenProBold38"
                >
                  Nearby
                </Text>
                <div className="flex md:flex-col flex-row font-lilitaone md:gap-10 items-center justify-between ml-1 md:ml-[0] mt-[5px] w-full">
...
export default ReccomendationswmenuPage;
