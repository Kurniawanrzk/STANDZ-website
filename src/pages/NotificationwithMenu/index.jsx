...
const NotificationwithMenuPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    <>
      <div className="bg-lime-600 flex flex-col font-kd items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row gap-[25px] items-start justify-between mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-1 flex-col font-mitr gap-8 items-center justify-start md:mt-0 mt-[55px] w-full">
            <div className="flex flex-col gap-[49px] justify-start w-full">
              <div className="flex md:flex-col flex-row font-inriasans md:gap-10 items-start justify-between md:ml-[0] ml-[30px] w-[98%] md:w-full">
            ...
            <div className="bg-gray-300_aa flex flex-col items-start justify-start p-[11px] rounded-[35px]">
              <Text
                className="md:ml-[0] ml-[38px] md:text-3xl sm:text-[28px] text-[32px] text-black-900_bf"
                size="txtMitrBold32"
              >
                Land rent
              </Text>
              <Text
                className="md:ml-[0] ml-[41px] sm:text-2xl md:text-[26px] text-[28px] text-black-900"
...
export default NotificationwithMenuPage;
