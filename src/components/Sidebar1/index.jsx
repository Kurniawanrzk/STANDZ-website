...
const Sidebar1 = (props) => {
  ...
  return (
    <>
      ...
      >
        <div className="md:h-[126px] h-[140px] md:ml-[0] ml-[62px] mr-[58px] mt-[26px] relative w-[55%]">
          <Img
            className="absolute h-[100px] inset-x-[0] mx-auto object-cover top-[0] w-[81%]"
        ...
        <Menu
          menuItemStyles={{
            button: {
              ...
              borderStyle: "solid",
              borderRadius: "20px",
              [`&:hover, &.ps-active`]: { borderColor: "#000000ff" },
            },
          }}
          className="flex flex-col items-center justify-start mb-[319px] mt-52 pl-[33px] pr-[30px] pt-1 sm:px-5 w-[77%]"
        >
